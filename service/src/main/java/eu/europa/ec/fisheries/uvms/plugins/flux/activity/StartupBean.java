...
import eu.europa.ec.fisheries.uvms.plugins.flux.activity.jms.producer.PluginToEventBusTopicProducer;
import eu.europa.ec.fisheries.uvms.plugins.flux.activity.service.FileHandlerBean;
...
public class StartupBean extends PluginDataHolder {
    ...
    private String getPLuginApplicationProperty(String key) {
        try {
            ...
            log.error("Failed to getSetting for key: " + key + " class:" + getRegisterClassName(),e);
            return null;
        }
    }
    ...
    public String getSetting(String key) {
        try {
            ...
            log.error("Failed to getSetting for key: " + key + " class:" + registeredClassName,e);
            return null;
        }
    }
