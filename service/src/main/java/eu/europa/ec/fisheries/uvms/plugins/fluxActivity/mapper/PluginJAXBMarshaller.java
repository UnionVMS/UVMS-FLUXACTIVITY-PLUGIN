...
public class PluginJAXBMarshaller {
     ...
     * @return
     * @throws
     * eu.europa.ec.fisheries.uvms.plugins.fluxActivity.exception.PluginException
     */
    public static <T> String marshallJaxBObjectToString(T data) throws PluginException {
        try {
            ...
            throw new PluginException("[ Error when marshalling Object to String ]");        }
    }
     ...
     * eu.europa.ec.fisheries.uvms.plugins.fluxActivity.exception.PluginException
     */
    public static <R> R unmarshallTextMessage(TextMessage textMessage, Class clazz) throws PluginException {
        try {
            ...
            throw new PluginException("[Error when unmarshalling response in ResponseMapper. Expected class was " + clazz.getName() + " ]");
        }
    }

    public static <R> R unMarshallMessage(String textMessage, Class clazz) throws PluginException {
        try {
